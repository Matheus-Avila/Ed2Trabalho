...
class no{
    ...
    void leftRotate(arvoreVP* arvore);// Faz a rotacao do no atual e seus filhos para a esquerda
    void rightRotate(arvoreVP* arvore);// Faz a rotacao do no atual e seus filhos para a direita
