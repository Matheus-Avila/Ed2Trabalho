...
class pagina{
    ...
    void inserirNaFolha(chave* chaveNova, int* comparacoes, int* trocas); //Antes de inserir na folha,
    // ordena as chaves da folha, e insere o valor
    void splitPagina(int* comparacoes, int* trocas);//Divide a pagina lotada     
